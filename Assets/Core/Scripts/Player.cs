...
public class Player : Unit
{
    ...
    private void UpdateExperienceRequiredForLevel ()
    {
        ...
        //Scale the XP required on the player's current level
        float xpScalingFactor = GameManager.playerExperienceValues.xpGrowthPerLevel;
        experienceToNextLevel *= Mathf.Pow(xpScalingFactor, currentLevel);
    }
